...
public class PersonalInformationWrapper implements Entity {
    ...
    public PersonalInformationWrapper() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PersonalInformationWrapper)) return false;
        PersonalInformationWrapper that = (PersonalInformationWrapper) o;
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("PersonalInformationWrapper{");
